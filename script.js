...
async function getJoke() {
    let apiUrl = 'https://v2.jokeapi.dev/joke/Any';
     ...
     console.log(apiJoke);
     apiJokeSetup = apiJoke.setup;
     apiJokeDelivery = apiJoke.delivery;
     test(apiJokeSetup, apiJokeDelivery);
  } catch(error) {
...
function test(apiJokeSetup, apiJokeDelivery) {
  VoiceRSS.speech({
    key: '5a8a2d8d903a4e34849dbb2a8d863518',
    src: `${apiJokeSetup} + "     " + ${apiJokeDelivery}`,
    hl: 'en-us',
    v: 'Linda',
    r: 0, 
    c: 'mp3',
