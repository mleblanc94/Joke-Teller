...
async function getJoke() {
    let apiUrl = 'https://v2.jokeapi.dev/joke/Programming?blacklistFlags=nsfw,religious,racist,sexist&type=single';
       try {
     const response = await fetch(apiUrl);
     apiJoke = await response.json();
     console.log(apiJoke);
     apiJokeDelivery = apiJoke.joke;
     test(apiJokeDelivery);
  } catch(error) {
